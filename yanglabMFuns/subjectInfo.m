...
% A MATLAB GUI to acquire subject information
% Last Modified by Yang Zhang v2.5 08-Jun-2020 13:06:53
...
try %#ok<TRYNC>
	...
	try
	    set(handles.run,'String',num2str(str2double(lastSavedData.output.run)+1));
	end

	set(handles.num,'String',lastSavedData.output.num);
...
if isempty(handles)
    ...
    output.run      = get(handles.run,'String');
    output.session  = get(handles.session,'String');
    output.filename = [handles.expName,'_',output.num,'_',output.run,'_',output.session];
...
if exist('groot','builtin')
    dpiScale = get(groot,'ScreenPixelsPerInch')/96;
else
    dpiScale = 1; % for matlab older than 2014
end

fSize = [376,325]*dpiScale;

ttemp=get(0,'ScreenSize');
ScreenS = [(ttemp(3)-fSize(1))/2,(ttemp(4)-fSize(2))/2,fSize(1),fSize(2)];
...
'String','Handedness:',...
'Style','text',...
'Position',[0.12 0.428571428571429 0.29 0.0779220779220779],...
'BackgroundColor',bkColor,...
'Children',[],...
'Tag','text4',...
'FontSize',12,...
...
'String','SubjectNum',...
'Style','text',...
'Position',[0.11 0.31 0.24 0.064935064935065],...
'BackgroundColor',bkColor,...
'Children',[],...
'Tag','text6',...
'FontSize',12,...
...
'String','22',...
'Style','edit',...
'Position',[0.15 0.22 0.17 0.0844155844155844],...
'BackgroundColor',bkColor,...
...
'String','Run',...
'Style','text',...
'Position',[0.425 0.31 0.17 0.0616883116883117],...
'BackgroundColor',bkColor,...
'Children',[],...
'Tag','text6',...
'FontSize',12,...
...
'String','1',...
'Style','edit',...
'Position',[0.425 0.22 0.17 0.0844155844155844],...
'BackgroundColor',bkColor,...
'Callback',@(hObject,eventdata)subjectInfo('run_Callback',hObject,eventdata,guidata(hObject)),...
'Children',[],...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)subjectInfo('run_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','run',...
'FontSize',12,...
'FontName','Arial');

appdata = [];
appdata.lastValidTag = 'run_text_edit';
...
'String','Session',...
'Style','text',...
'Position',[0.7 0.31 0.17 0.0616883116883117],...
'BackgroundColor',bkColor,...
'Children',[],...
'Tag','text7',...
'FontSize',12,...
